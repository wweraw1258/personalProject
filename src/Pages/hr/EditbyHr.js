...
const EditHr = () => {
    ...
    const [Research, setResearch] = useState([{
        "form":
            <>
                ...
                <div class="mb-3">
                    <textarea class="form-control" placeholder="ชื่อผู้แต่ง./(ปีพิมพ์)./ชื่อเรื่อง/(ปริญญานิพนธ์มหาบัณฑิต/ปริญญานิพนธ์ดุษฎีบัณฑิต)./ชื่อสถานศึกษา,/ที่ตั้ง."></textarea>
                </div>
            </>
        , "value": 0
    }
    ...
    const [Compiled, setCompiled] = useState([{
        "form":
            <>
                <div className="rama-x">
                    <p>ชื่องานแต่งและเรียบเรียง</p>
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control" placeholder="ชื่องานแต่งและเรียบเรียง" />
                </div>
            </>
        , "value": 0
    }
    ...
    const [Service, setService] = useState([{
        "form":
            <>
                <div className="rama-x">
                    <p>ชื่องานด้านบริการวิชาการ</p>
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control" placeholder="ชื่องานด้านบริการวิชาการ" />
                </div>
            </>
        , "value": 0
    }
                    ...
                    temp_reward.push({
                        "form":
                            <>
                                ...
                                <div class="mb-3">
                                    <input class="form-control" type="number" className="form-control" min="1900" max="2099" step="1" id={"rewardYear" + i} />
                                </div>
