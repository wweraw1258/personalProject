...
const SearchDataHr = () => {
  ...
  const getalldata = async () => {
    ...
    try {
      const res = await axios.post(`${api}/hr/alluser`, { accesstoken: token })
                              ...
                              <tr>
                                ...
                                <Container>
                                  ...
                                  <i onClick={() => {
                                    ...
                                    navigate("/EditbyHr", { state: { gmail: dataUser[i].gmail } })
                                  }} className="coloricon">
                                    <AiIcons.AiFillEdit />
                                  </i>
                                  </Col>
                                  <Col>
                                  <i onClick={() => { navigate("/ShowDataHr", { state: { gmail: dataUser[i].gmail } }) }} className="coloricon2">
                                    <AiIcons.AiFillEye />
                                  </i>
                                  </Col>
                                  </Row>
                            ...
                            return (
                              <tr>
                                ...
                                <Container>
                                  ...
                                  <Col>
                                  <i onClick={() => {
                                    navigate("/EditByHr", { state: { gmail: tempDataUser[i].gmail } })
                                  ...
                                  <Col>
                                  <i onClick={() => { navigate("/ShowDataHr", { state: { gmail: tempDataUser[i].gmail } }) }} className="coloricon2">
                                    <AiIcons.AiFillEye />
                                  </i>
                                  </Col>
                                  </Row>
